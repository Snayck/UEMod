...
// #include "OffsetFinder/Offsets.h"  // Not available, commented out
// #include "Encoding/UnicodeNames.h"  // Not available, commented out  
// #include "Utils.h"  // Not available, commented out
...
public:
	...
	~FFreableString()
	{
		...
		// if (Off::InSDK::Name::bIsUsingAppendStringOverToString)  // Not available
			FreeArray();
	}
